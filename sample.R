...
# 予測 
pred <- predict(model, burn=100, newdata=d_test3[,-1])
...
plot(pred$mean, ylim = c(0, 600), xlab = '', ylab = '')

par(new = T)
#plot(x=c(0:400),d_train2$CustNum, ylim = c(0,1500), axes = F, type = 'l', col = 'red', lwd = 1, lty = 5, xlab = '', ylab = '')

plot(d_test2$CustNum, ylim = c(0,600), axes = F, type = 'l', col = 'red', lwd = 3, lty = 1, xlab = '', ylab = '')
